          ...
          <div className="px-40 flex flex-1 justify-center py-5">
            <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
              ...
              <div className="px-4 py-6">
                  <button
                    onClick={() => navigate('/consult', { state: { specialist: reportData['specialistReq'] } }) }
                    style={{margin:'auto'}}
                    className="w-half py-3 px-6 bg-[#607AFB] hover:bg-[#e7e9eb] text-[#F9FAFA] rounded-xl transition-colors duration-200 text-base font-medium flex items-center justify-center gap-2"
                  >
                    <Stethoscope size={20} />
                    consult near by doctors
                  </button>
                </div>
              ...
              <div className="px-4 py-6">
                <button 
                  onClick={() => {
                    navigate('/Food', { state: { prompt: reportData.Diet } });
                    // Or using plain JavaScript
                    // window.location.href = '/Food';
                    // sessionStorage.setItem('dietPrompt', reportData.diet);
                  }}
                  className="w-full py-3 px-6 bg-[#f0f2f4] hover:bg-[#e7e9eb] text-[#111418] rounded-xl transition-colors duration-200 text-base font-medium flex items-center justify-center gap-2"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M3 15C3 15 5.73 13 9 13C12.27 13 14.27 15 18 15C21.73 15 23 13 23 13V5C23 5 21.73 3 18 3C14.27 3 12.27 5 9 5C5.73 5 3 3 3 3V15Z"/>
                    <path d="M3 15V21"/>
                  </svg>
