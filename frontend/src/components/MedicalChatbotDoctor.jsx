...
import { Send, Loader, Stethoscope, X } from 'lucide-react';
import axios from 'axios';

const MedicalChatbotDoctor = () => {
  ...
  const toggleChatbot = () => {
    ...
    if (isFirstOpen) {
      const welcomeMessage = {
        text: "Hello! I'm Althea, your personalized medical chatbot. I'm here to assist Patients with their queries. How can I help you today?",
        sender: 'bot'
      };
  ...
  const sendMessage = async (e) => {
    ...
    try {
      const data = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/en/MedicalChatbotDoctor`, { input: input });
...
export default MedicalChatbotDoctor;